...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2019 a las 18:04:45
...
--
ALTER TABLE `servicio`
  ADD CONSTRAINT `servicio_ibfk_1` FOREIGN KEY (`Codigo_Vehiculo`) REFERENCES `vehiculo` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
