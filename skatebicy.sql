...
INSERT INTO `clientes` (`numero`, `Cedula`, `Nombres`, `Apellidos`, `Correo`, `Celular`, `Barrio`)
...
INSERT INTO `vehiculo` (`codigo`, `Nombre_Vehiculo`, `Caracteristicas`, `Precio_Hora`, `Precio_Dia`, `Disponibilidad`)
VALUES (1, 'patineta',
