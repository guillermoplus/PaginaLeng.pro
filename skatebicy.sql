...
INSERT INTO `clientes` (`numero`, `Cedula`, `Nombres`, `Apellidos`, `Correo`, `Celular`, `Barrio`) VALUES
(1, '1007478930', 'liliana', 'rodriguez lopez', 'lilirodriguez@gmail.', '3115466589', 'la paz'),
(2, '1118507508', 'Dulber Adrian', 'Garcia Corredor', 'adri18@gmail.com', '3144307065', 'laureles'),
...
INSERT INTO `detallefactura` (`Num_Facturacliente`, `Cantidad_Servicios`, `Precio_Alquiler`) VALUES
('1', 2, 48000),
('2', 2, 2),
('3', 1, 1000),
('4', 3, 72000),
...
INSERT INTO `direccion` (`Barrio_cliente`, `Carrera`, `Calle`, `Num_Casa`) VALUES
('araguaney', '12', '24', '5'),
('campiña', '13', '12', '3'),
('la 40', '26', '15', '11'),
('la paz', '19', '24', '3'),
...
INSERT INTO `factura` (`Num_Factura`, `Num_Servicio`, `Cedula_cliente`) VALUES
('1', '1', '13437652'),
('2', '2', '9653957'),
('3', '4', '47354678'),
('4', '3', '47434903'),
...
INSERT INTO `servicio` (`Num_Servicio`, `Codigo_Vehiculo`, `Fecha_Alquiler`, `Fecha_Entrega`) VALUES
...
ALTER TABLE `detallefactura`
  ADD KEY `Num_Factura` (`Num_Facturacliente`);

--
-- Indexes for table `direccion`
--
ALTER TABLE `direccion`
  ADD PRIMARY KEY (`Barrio_cliente`);
...
--
ALTER TABLE `detallefactura`
  ADD CONSTRAINT `detallefactura_ibfk_1` FOREIGN KEY (`Num_Facturacliente`) REFERENCES `factura` (`Num_Factura`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `direccion`
--
ALTER TABLE `direccion`
  ADD CONSTRAINT `direccion_ibfk_1` FOREIGN KEY (`Barrio_cliente`) REFERENCES `clientes` (`Barrio`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `factura`
--
ALTER TABLE `factura`
  ADD CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`Num_Servicio`) REFERENCES `servicio` (`Num_Servicio`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `factura_ibfk_3` FOREIGN KEY (`Cedula_cliente`) REFERENCES `clientes` (`Cedula`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `servicio`
--
ALTER TABLE `servicio`
  ADD CONSTRAINT `servicio_ibfk_1` FOREIGN KEY (`Codigo_Vehiculo`) REFERENCES `vehiculo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
