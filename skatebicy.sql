...
VALUES ('1', 1, '2019-11-01', '2019-11-02'),
...
(
    ...
    `email`     varchar(20)   NOT NULL DEFAULT '' COMMENT 'correo del cliente',
...
VALUES (1, '1007478930', 'liliana', 'rodriguez lopez', 'lilirodriguez@gmail.', '3115466589', 'la paz', ''),
...
--
ALTER TABLE `direccion`
    ADD CONSTRAINT `direccion_ibfk_1` FOREIGN KEY (`Barrio_cliente`) REFERENCES `usuarios` (`barrio`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `factura`
    ...
    ADD CONSTRAINT `factura_ibfk_3` FOREIGN KEY (`Cedula_cliente`) REFERENCES `usuarios` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE;
