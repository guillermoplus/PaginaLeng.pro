...
# Base de datos: skatebicy
# Tiempo de Generación: 2019-12-20 17:42:56 +0000
# ************************************************************
...
# Volcado de tabla detallefactura
# ------------------------------------------------------------
...
INSERT INTO `detallefactura` (`Num_Facturacliente`, `Cantidad_Servicios`, `Precio_Alquiler`)
VALUES
	('1',2,48000),
	('2',2,2),
	('3',1,1000),
...
CREATE TABLE `direccion` (
  ...
  CONSTRAINT `direccion_ibfk_1` FOREIGN KEY (`Barrio_cliente`) REFERENCES `usuarios` (`barrio`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `direccion` WRITE;
/*!40000 ALTER TABLE `direccion` DISABLE KEYS */;

INSERT INTO `direccion` (`Barrio_cliente`, `Carrera`, `Calle`, `Num_Casa`)
VALUES
	('araguaney','12','24','5'),
	('campiña','13','12','3'),
	('la 40','26','15','11'),
	...
	('paraiso','20','21','9'),
	('unidad','23','14','4'),
	('villa horizonte','34','27','6');

/*!40000 ALTER TABLE `direccion` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla factura
# ------------------------------------------------------------
...
CREATE TABLE `factura` (
  ...
  CONSTRAINT `factura_ibfk_3` FOREIGN KEY (`Cedula_cliente`) REFERENCES `usuarios` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `factura` WRITE;
/*!40000 ALTER TABLE `factura` DISABLE KEYS */;

INSERT INTO `factura` (`Num_Factura`, `Num_Servicio`, `Cedula_cliente`)
VALUES
	('1','1','13437652'),
	('2','2','9653957'),
	('3','4','47354678'),
...
CREATE TABLE `servicio` (
  ...
  CONSTRAINT `servicio_ibfk_1` FOREIGN KEY (`Codigo_Vehiculo`) REFERENCES `vehiculo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `servicio` WRITE;
/*!40000 ALTER TABLE `servicio` DISABLE KEYS */;

INSERT INTO `servicio` (`Num_Servicio`, `Codigo_Vehiculo`, `Fecha_Alquiler`, `Fecha_Entrega`)
VALUES
	('1',1,'2019-11-01','2019-11-02'),
	('10',10,'2019-11-17','2019-11-18'),
	('2',2,'2019-11-04','2019-11-05'),
	('3',3,'2019-11-05','2019-11-06'),
	('4',4,'2019-11-07','2019-11-08'),
	('5',5,'2019-09-04','2019-09-05'),
	('6',6,'2019-11-14','2019-11-15'),
	('7',7,'2019-10-16','2019-10-17'),
	('8',8,'2019-12-03','2019-11-04'),
	('9',9,'2019-08-01','2019-08-02');
...
CREATE TABLE `usuarios` (
  ...
  `cedula` varchar(14) NOT NULL DEFAULT '' COMMENT 'cedula del cliente ',
  `nombres` varchar(60) NOT NULL DEFAULT '' COMMENT 'nombres del cliente',
  `apellidos` varchar(60) NOT NULL DEFAULT '' COMMENT 'apellidos del cliente',
  `email` varchar(50) NOT NULL DEFAULT '' COMMENT 'correo del cliente',
  `celular` varchar(15) NOT NULL DEFAULT '' COMMENT 'numero del celular del cliente',
  `barrio` varchar(30) NOT NULL DEFAULT '' COMMENT 'barrio donde vive el cliente',
...
INSERT INTO `usuarios` (`id`, `cedula`, `nombres`, `apellidos`, `email`, `celular`, `barrio`, `password`)
VALUES
	(1,'1007478930','liliana','rodriguez lopez','lilirodriguez@gmail.','3115466589','la paz',''),
	(2,'1118507508','Dulber Adrian','Garcia Corredor','adri18@gmail.com','3144307065','laureles','123'),
	(3,'1118543597','luisa','cardenas holguin','luisa23@gmail.com','3124578680','unidad',''),
	(4,'1118566614','angie bibiana','colina ortiz','bibicolina@gmail.com','3109876543','la 40',''),
	(10,'1118572543','julieth natalia','velandia achagua','juli@gmail.com','3165647890','oasis',''),
	(5,'13437652','luis','bedolla martinez','luisbedolla@gmail.co','3125656565','araguaney',''),
	(6,'47354678','rosalba ','peña pinto','rosita@gmail.com','3107600180','campiña',''),
	(7,'47434903','Marlen','Corredor Siabato','corredormarlen@gmail','3175883508','araguaney',''),
	(8,'47657809','carmen Rosa','Rodriguez Mendoza','carmenro@gmail.com','3143861525','paraiso',''),
	(9,'9653957','daniel','figueron castillo','danielortiz@gmail.co','3182789507','villa horizonte','');

/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla vehiculo
# ------------------------------------------------------------

DROP TABLE IF EXISTS `vehiculo`;

CREATE TABLE `vehiculo` (
  `id` int(11) NOT NULL COMMENT 'código de vehículo alquilado',
  `nombre` varchar(20) NOT NULL DEFAULT '' COMMENT 'nombre del vehículo alquilado',
